...
me.init = function()	
	if not mod:pcall(me.create_screen_ui) then
		init_error = true
		me.create_screen_ui()
		init_error = false
	end
...
me.create_screen_ui = function()
	...
	if (Managers.state.game_mode == nil or Managers.state.game_mode._game_mode_key == "inn") and not init_error then
		me.gui = World.create_screen_gui(world, "immediate",
			...
			-- The line below was not commented out originally, but Vermintide kept complaining about it not being found
			-- No idea what the significance of these materials is
...
--]]
me.rect_vectors = function(position, size, color)
	Gui.rect(me.gui, position, size, color)
end
--[[
	Draw text with vectors
--]]
me.text_vectors = function(text, position, font_size, color, font)
...
--]]
me.bitmap_uv = function(atlas, uv00, uv11, position, size, color)
...
--]]
me.rect = function(arg1, arg2, arg3, arg4, arg5, arg6)
...
--]]
me.text = function(arg1, arg2, arg3, arg4, arg5, arg6, arg7)
	local color = Color(255, 255, 255, 255)
...
--]]
me.to_lines = function(text, font_size, font_material, colors)
	...
	for line in string.gmatch(text.."\n", "([^\n]*)\n") do
		local w = me.text_width(line, font_material, font_size)
...
--]]
me.tooltip = function(str, colors, font_size, line_padding, offset, padding, font_material, size)
	mod:pcall(function()
		...
		-- Transform string
		local text = me.to_lines(str, font_size, font_material, colors)
		...
		me.rect(Vector3(x, y, 999), size, Color(200, 0, 0, 0))
		-- Render lines
		--EchoConsole("rofl")
		...
		for _, line in pairs(text.lines) do
			if line.text ~= "#" then
				...
				me.text(line.text, Vector3(text_x, text_y, 999), font_size, color)
			end
...
--]]
me.side_mission_icon = function(position, text, text_offset, color, size, font_size, font, text_color)
...
me.tome_icon = function(position, color, size)
...
me.grim_icon = function(position, color, size)
...
me.draw_icon = function(icon_texture, position, color, size, atlas, uv00, uv11)
	local icon_settings = UIAtlasHelper.get_atlas_settings_by_texture_name(icon_texture)
...
--]]
me.text_width = function(text, font, font_size)
...
--]]
me.text_height = function(text, font, font_size)
	local text_extent_min, text_extent_max = Gui.text_extents(me.gui, text, font or me.default_font, font_size or me.default_font_size)
